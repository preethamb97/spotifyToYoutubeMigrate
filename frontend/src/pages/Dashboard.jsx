        ...
        {!user.hasSpotify && (
          <div className="mb-6 sm:mb-8 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8 shadow-xl">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              ...
              <a
                href="/auth/spotify"
                className="w-full sm:w-auto bg-spotify-green hover:bg-green-600 text-white font-semibold px-6 py-3 sm:py-4 rounded-xl text-sm sm:text-base transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2"
              >
